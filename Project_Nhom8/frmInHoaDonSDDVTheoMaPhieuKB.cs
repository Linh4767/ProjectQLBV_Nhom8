...
{
    public partial class frmInHoaDonSDDVTheoMaPhieuKB : Form
    {
        public frmInHoaDonSDDVTheoMaPhieuKB()
        {
            InitializeComponent();
        }
        public string Data { get; set; }
        public frmInHoaDonSDDVTheoMaPhieuKB(string data)
        {
            InitializeComponent();
            Data = data;
            // Bạn có thể thao tác với dữ liệu ở đây, ví dụ hiển thị lên một control nào đó
        }
        private void frmInHoaDonSDDVTheoMaPhieuKB_Load(object sender, EventArgs e)
        {
